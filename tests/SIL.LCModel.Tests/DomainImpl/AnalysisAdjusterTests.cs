...
namespace SIL.LCModel.DomainImpl
{
	...
	class AdjustmentVerifier
	{
		...
		internal AdjustmentVerifier(LcmCache cache)
		{
			Cache = cache;
	...
	{
		internal BothWaysAdjustmentVerifier(LcmCache cache) : base(cache)
		{
		}
	...
	class AdjustmentVerifierPlusTags : AdjustmentVerifier
	{
		...
		internal AdjustmentVerifierPlusTags(LcmCache cache) : base(cache)
		{
			Cache = cache;
		...
		/// </summary>
		protected ICmPossibility[] SetupTagPossibilities(LcmCache cache)
		{
	...
	class AdjustmentVerifierPlusChartCells : AdjustmentVerifier
	{
		...
		internal AdjustmentVerifierPlusChartCells(LcmCache cache)
			: base(cache)
		{
			Cache = cache;
	...
	internal class TestAnalysisReference : IAnalysisReference
	{
		...
		public ILcmServiceLocator Services { get { throw new NotImplementedException(); } }
		...
		public LcmCache Cache { get { throw new NotImplementedException(); } }

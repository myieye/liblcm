...
using SIL.Reporting;
using Segment = SIL.LCModel.DomainImpl.Segment;
using StStyle = SIL.LCModel.DomainImpl.StStyle;
...
namespace SIL.LCModel.DomainServices
{
	...
	public static class DataStoreInitializationServices
	{
		...
		/// <param name="cache">The cache.</param>
		/// ------------------------------------------------------------------------------------
		private static void EnsureValidVersification(LcmCache cache)
		{
		...
		/// </summary>
		/// ------------------------------------------------------------------------------------
		private static void RemoveOldKeyTermsList(LcmCache cache)
		{
		...
		/// <param name="cache">The cache.</param>
		/// ------------------------------------------------------------------------------------
		internal static void EnsureSegmentsForScrParas(LcmCache cache)
		{
			IScripture scr = cache.LanguageProject.TranslatedScriptureOA;
		...
		/// ------------------------------------------------------------------------------------
		internal static void EnsureSegmentsForPara(IScrTxtPara para)
		{
		...
		/// <param name="cache">The cache.</param>
		/// ------------------------------------------------------------------------------------
		internal static void EnsureBtForScrParas(LcmCache cache)
		{
			IScripture scr = cache.LanguageProject.TranslatedScriptureOA;
		...
		/// <param name="para">The paragraph.</param>
		/// ------------------------------------------------------------------------------------
		internal static void EnsureBtForPara(IScrTxtPara para)
		{
		...
		/// </summary>
		/// ------------------------------------------------------------------------------------
		internal static void FixSegmentsForScriptureParas(LcmCache cache)
		{
			...
			if (hadError)
			{
				...
				cache.ServiceLocator.GetInstance<ILcmUI>().ReportException(new Exception("Error during resegmentation"), false);
			}
		}
		...
		/// </returns>
		/// ------------------------------------------------------------------------------------
		internal static bool ParaSegmentsValid(IScrTxtPara para, bool fCheckForEmptySegments,
		...
		/// <param name="para">The paragraph.</param>
		/// ------------------------------------------------------------------------------------
		internal static void BlowAwaySegments(IScrTxtPara para)
		{
		...
		/// </summary>
		/// ------------------------------------------------------------------------------------
		internal static void FixSegmentsForPara(IScrTxtPara para)
		{
		...
		/// <param name="cache">The cache.</param>
		/// ------------------------------------------------------------------------------------
		internal static void EnsureStylesInUseSetForScrParas(LcmCache cache)
		{
			IScripture scr = cache.LanguageProject.TranslatedScriptureOA;
